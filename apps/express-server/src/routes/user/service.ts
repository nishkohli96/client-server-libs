...
import { UserModelCreationAttributes, UserModel, InactiveUserModel } from '@/db/mysql/models';
...
class UserService {
	...
	async getInactiveUsers(res: Response) {
	  try {
	    ...
	    return sendErrorResponse(res, error, 'Unable to get list of inactive users');
	  }
	}
}
