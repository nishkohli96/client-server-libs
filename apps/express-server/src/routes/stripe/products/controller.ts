...
stripeProductRouter.post(
  `/${subRoutes.create}`,
  async function createProduct(req: StripeProductsTypedefs.CreateProductRequest, res: Response) {
...
stripeProductRouter.patch(
  ...
  async function updateProduct(req: StripeProductsTypedefs.UpdateProductRequest, res: Response) {
...
stripeProductRouter.get(
  ...
  async function getProduct(req: StripeProductsTypedefs.GetProductRequest, res: Response) {
...
stripeProductRouter.post(
  `/${subRoutes.list}`,
  async function listProducts(req: StripeProductsTypedefs.ListProductsRequest, res: Response) {
...
stripeProductRouter.get(
  `/${subRoutes.search}`,
  async function searchProducts(req: StripeProductsTypedefs.SearchProductsRequest, res: Response) {
...
stripeProductRouter.delete(
  ...
  async function deleteProduct(req: StripeProductsTypedefs.GetProductRequest, res: Response) {
